...
import com.example.madpractical11.databinding.ActivityMainBinding
import com.example.madpractical11.databinding.NoteEditViewBinding
...
// add a button
        builder.setPositiveButton(
            ...
            (binding.reminderTime.hour, binding.reminderTime.minute)
            else
            newNote.remindertime = Note.getMillis
            (binding.reminderTime.currentHour, binding.reminderTime.currentMinute)
